...
INSERT INTO `handphone` (`id_handphone`, `id_hp`, `nama`, `harga`) VALUES
(16, 111233444, 'Lenovo Z60 pro', 'Rp. 13.000.000'),
(21, 1222111, 'Xiaomi Black Shark', 'Rp. 15.000.000'),
(22, 1111111, 'Asus ROG Phone', 'Rp. 22.000.000');
...
ALTER TABLE `krs`
  ...
  ADD KEY `id_mahasiswa` (`id_handphone`),
...
--
ALTER TABLE `handphone`
  MODIFY `id_handphone` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `krs`
  ADD CONSTRAINT `krs_ibfk_1` FOREIGN KEY (`id_handphone`) REFERENCES `handphone` (`id_handphone`) ON DELETE CASCADE ON UPDATE CASCADE,
